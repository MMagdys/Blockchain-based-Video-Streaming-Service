...
exports.updateContentTrie = function updateContentTrie(transactions, oldContentTree, timestamp) {
        ...
        if(tx.contentBase){
            ...
            // IF Media content
                ...
                if(verifySignature(metaHash, tx.outputs.signature, channel.pubKey)) {
                    ...
                    channel.contents.unshift({...tx.outputs.metaData, timestamp: timestamp})
